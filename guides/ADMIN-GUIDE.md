...
![관리자 화면 열기·로그인 — v104 화면, 가상자료](images/admin-01-login.png)
...
![프로그램 기본정보 등록 — v104 화면, 가상자료](images/admin-02-register.png)

홈페이지 링크나 홍보지 내용 자동입력을 사용했다면 원문과 대조해 수정합니다. 이미지는 기본정보 화면의 위쪽 부분입니다.

## 3. 신청 방식 설정·최종 저장

프로그램에 필요한 개인정보 동의 항목을 확인하고, 필요에 따라 추가 설문 또는 신청서 파일 제출 방식을 설정합니다. 내용을 검토한 뒤 프로그램 최종 저장을 누릅니다.

![신청 방식 설정·최종 저장 — v104 화면, 가상자료](images/admin-06-settings.png)

추가 설문은 설문 관리에서 준비하여 연결합니다. 저장 전에 이용자 화면과 신청 순서를 확인하세요. 아래 이미지는 가상 프로그램의 설정 예시입니다.

## 4. 추가 설문 만들기

설문 관리에서 새 설문을 만들고 질문과 응답 유형을 정합니다. 왼쪽에서 문항을 편집하면서 오른쪽 이용자 화면 미리보기로 확인합니다.

![추가 설문 만들기 — v104 화면, 가상자료](images/admin-03-survey.png)
...
![등록한 프로그램 관리 — v104 화면, 가상자료](images/admin-04-programs.png)
...
![신청자·제출자료 확인 — v104 화면, 가상자료](images/admin-05-applicants.png)
